...
function SignUp() {
  ...
  return (
    <>
      <div style={{
        minHeight: '100vh',
        background: 'linear-gradient(to bottom right,rgb(12, 89, 87),rgb(18, 117, 87))',
        display: 'flex',
        ...
        <div style={{
          ...
          <div style={{
            flex: 1,
            background: 'linear-gradient(135deg,rgb(12, 97, 74),rgb(18, 104, 84))',
            padding: '2rem',
            display: 'flex',
            flexDirection: 'column',
            justifyContent: 'center',
            ...
            <div style={{
              ...
              <p style={{
                ...
                Join thousands of passionate educators and educational enthusiasts on the PROLEARN platform.
                Start sharing your knowledge and e-learning expertise today.
